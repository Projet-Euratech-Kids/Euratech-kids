 ...
 */
final class Version20200221083418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE min_age min_age INT DEFAULT NULL, CHANGE max_age max_age INT DEFAULT NULL');
